...
**reason_type** | [**\OpenAPI\Client\Model\ExternalReturnDecisionReasonType**](ExternalReturnDecisionReasonType.md) |  |
**subreason_type** | [**\OpenAPI\Client\Model\ExternalReturnDecisionSubreasonType**](ExternalReturnDecisionSubreasonType.md) |  |
**comment** | **string** | Комментарий к товару в возврате. | [optional]
**pictures** | **string[]** | Ссылки (URL) на изображения товара в возврате. | [optional]
