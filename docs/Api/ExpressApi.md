...
try {
    ...
    echo 'Exception when calling ExpressApi->generateGoodsPricesReport: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ExpressApi->generateOfferBarcodes: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ExpressApi->getBusinessOrders: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ExpressApi->getGoodsQuestionAnswers: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ExpressApi->getGoodsQuestions: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ExpressApi->getReturnAvailableDecisions: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ExpressApi->updateGoodsQuestionTextEntity: ', $e->getMessage(), PHP_EOL;
}
```
