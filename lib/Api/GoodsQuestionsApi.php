...
class GoodsQuestionsApi
{
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\GetAnswersResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    public function getGoodsQuestionsWithHttpInfo($business_id, $page_token = null, $limit = 25, $get_questions_request = null, string $contentType = self::contentTypes['getGoodsQuestions'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\GetQuestionsResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    public function updateGoodsQuestionTextEntityWithHttpInfo($business_id, $update_goods_question_text_entity_request, string $contentType = self::contentTypes['updateGoodsQuestionTextEntity'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\UpdateGoodsQuestionTextEntityResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\OpenAPI\Client\Model\UpdateGoodsQuestionTextEntityResponse';
        $request = $this->updateGoodsQuestionTextEntityRequest($business_id, $update_goods_question_text_entity_request, $contentType);
