...
class HiddenOffersApi
{
    ...
    public function addHiddenOffersRequest($campaign_id, $add_hidden_offers_request, string $contentType = self::contentTypes['addHiddenOffers'][0])
    {
        ...
        $resourcePath = '/v2/campaigns/{campaignId}/hidden-offers';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function deleteHiddenOffersRequest($campaign_id, $delete_hidden_offers_request, string $contentType = self::contentTypes['deleteHiddenOffers'][0])
    {
        ...
        $resourcePath = '/v2/campaigns/{campaignId}/hidden-offers/delete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getHiddenOffersRequest($campaign_id, $offer_id = null, $page_token = null, $limit = 250, string $contentType = self::contentTypes['getHiddenOffers'][0])
    {
        ...
        if ($limit !== null && $limit > 500) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling HiddenOffersApi.getHiddenOffers, must be smaller than or equal to 500.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling HiddenOffersApi.getHiddenOffers, must be bigger than or equal to 1.');
        }
