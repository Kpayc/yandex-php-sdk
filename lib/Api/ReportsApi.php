...
class ReportsApi
{
     ...
     *
     * @param  \OpenAPI\Client\Model\GenerateBarcodesReportRequest $generate_barcodes_report_request generate_barcodes_report_request (required)
     ...
     * Получение файла со штрихкодами
     *
     * @param  \OpenAPI\Client\Model\GenerateBarcodesReportRequest $generate_barcodes_report_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['generateBarcodesReport'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * Отчет «Цены»
     *
     * @param  \OpenAPI\Client\Model\GenerateGoodsPricesReportRequest $generate_goods_prices_report_request generate_goods_prices_report_request (required)
     * @param  \OpenAPI\Client\Model\ReportFormatType|null $format Формат отчета или документа. (optional)
     ...
     * Отчет «Цены»
     *
     * @param  \OpenAPI\Client\Model\GenerateGoodsPricesReportRequest $generate_goods_prices_report_request (required)
     * @param  \OpenAPI\Client\Model\ReportFormatType|null $format Формат отчета или документа. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['generateGoodsPricesReport'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
