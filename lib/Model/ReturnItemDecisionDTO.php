...
/**
 * ReturnItemDecisionDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class ReturnItemDecisionDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ReturnItemDecisionDTO';
    ...
    /**
     * Gets decision_reason_type
     *
     * @return \OpenAPI\Client\Model\ReturnRequestDecisionReasonType|null
     */
    public function getDecisionReasonType()
    {
        return $this->container['decision_reason_type'];
    }

    /**
     * Sets decision_reason_type
     *
     * @param \OpenAPI\Client\Model\ReturnRequestDecisionReasonType|null $decision_reason_type decision_reason_type
     *
     * @return self
     */
    public function setDecisionReasonType($decision_reason_type)
    {
        if (is_null($decision_reason_type)) {
            throw new \InvalidArgumentException('non-nullable decision_reason_type cannot be null');
        }
        $this->container['decision_reason_type'] = $decision_reason_type;
