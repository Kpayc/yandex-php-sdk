...
/**
 * GetDeliveryOptionsItemDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class GetDeliveryOptionsItemDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GetDeliveryOptionsItemDTO';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['warehouse_id']) && ($this->container['warehouse_id'] < 1)) {
    ...
    public function setOfferId($offer_id)
    {
        ...
        if ((mb_strlen($offer_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $offer_id when calling GetDeliveryOptionsItemDTO., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($offer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $offer_id when calling GetDeliveryOptionsItemDTO., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^(?=.*\\S.*)[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/", ObjectSerializer::toString($offer_id)))) {
            throw new \InvalidArgumentException("invalid value for \$offer_id when calling GetDeliveryOptionsItemDTO., must conform to the pattern /^(?=.*\\S.*)[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/.");
        }
    ...
    public function setCount($count)
    {
        ...
        if (($count > 1000)) {
            throw new \InvalidArgumentException('invalid value for $count when calling GetDeliveryOptionsItemDTO., must be smaller than or equal to 1000.');
        }
        if (($count < 1)) {
            throw new \InvalidArgumentException('invalid value for $count when calling GetDeliveryOptionsItemDTO., must be bigger than or equal to 1.');
        }
     ...
     * Sets warehouse_id
     *
     * @param int|null $warehouse_id Идентификатор фулфилмент-склада Маркета.  Передайте этот параметр, чтобы вернулись варианты доставки для указанного склада. Иначе Маркет сам выберет склад.  [Как узнать остатки товаров на складах](../../reference/stocks/getStocks.md)
     *
     * @return self
     */
    public function setWarehouseId($warehouse_id)
    {
        ...
        if (($warehouse_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $warehouse_id when calling GetDeliveryOptionsItemDTO., must be bigger than or equal to 1.');
        }
