...
class OutletLicenseDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setOutletId($outlet_id)
    {
        ...
        if (($outlet_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $outlet_id when calling OutletLicenseDTO., must be bigger than or equal to 1.');
        }
     ...
     * Gets license_type
     *
     * @return \OpenAPI\Client\Model\LicenseType
     */
     ...
     * Sets license_type
     *
     * @param \OpenAPI\Client\Model\LicenseType $license_type license_type
     *
     * @return self
     */
