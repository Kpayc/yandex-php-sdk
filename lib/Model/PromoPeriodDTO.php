...
/**
 * PromoPeriodDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class PromoPeriodDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PromoPeriodDTO';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['date_time_to'] === null) {
            $invalidProperties[] = "'date_time_to' can't be null";
        }
     ...
     * Sets date_time_from
     *
     * @param \DateTime $date_time_from Дата и время начала акции.
     *
     * @return self
     */
     ...
     * Sets date_time_to
     *
     * @param \DateTime $date_time_to Дата и время окончания акции.
     *
     * @return self
     */
