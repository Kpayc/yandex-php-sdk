...
class TariffType
{
    ...
    public const GOODS_ACCEPTANCE = 'GOODS_ACCEPTANCE';

    public const CARGO_ACCEPTANCE = 'CARGO_ACCEPTANCE';

    public const ORDER_PROCESSING = 'ORDER_PROCESSING';

    public const WITHDRAW_EXTERNAL = 'WITHDRAW_EXTERNAL';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::VOLUME_STORAGE,
            self::GOODS_ACCEPTANCE,
            self::CARGO_ACCEPTANCE,
            self::ORDER_PROCESSING,
            self::WITHDRAW_EXTERNAL
        ];
    }
}
