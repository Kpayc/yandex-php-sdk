...
/**
 * BusinessOrderShipmentDTO Class Doc Comment
 *
 * @category Class
 * @description Информация об отгрузке заказа.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class BusinessOrderShipmentDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BusinessOrderShipmentDTO';
     ...
     * Sets shipment_time
     *
     * @param string|null $shipment_time Время отгрузки.
     *
     * @return self
     */
