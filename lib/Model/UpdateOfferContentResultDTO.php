...
class UpdateOfferContentResultDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\Model\OfferContentErrorDTO[]|null $errors Ошибки.  Если хотя бы по одному товару есть ошибка, информация в каталоге не обновится по всем переданным товарам.
     *
     * @return self
     */
    public function setErrors($errors)
    {
        ...
        if (!is_null($errors) && (count($errors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $errors when calling UpdateOfferContentResultDTO., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets warnings
     *
     * @param \OpenAPI\Client\Model\OfferContentErrorDTO[]|null $warnings Предупреждения.  Информация в каталоге обновится.
     *
     * @return self
     */
    public function setWarnings($warnings)
    {
        ...
        if (!is_null($warnings) && (count($warnings) < 1)) {
            throw new \InvalidArgumentException('invalid length for $warnings when calling UpdateOfferContentResultDTO., number of items must be greater than or equal to 1.');
        }
