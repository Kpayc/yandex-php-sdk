...
/**
 * GenerateShowsBoostRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class GenerateShowsBoostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GenerateShowsBoostRequest';
    ...
    protected static $openAPITypes = [
        ...
        'date_from' => '\DateTime',
        'date_to' => '\DateTime',
        'attribution_type' => '\OpenAPI\Client\Model\StatisticsAttributionType'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['attribution_type'] === null) {
            $invalidProperties[] = "'attribution_type' can't be null";
        }
    ...
    public function setBusinessId($business_id)
    {
        ...
        if (($business_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $business_id when calling GenerateShowsBoostRequest., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\StatisticsAttributionType
     */
     ...
     *
     * @param \OpenAPI\Client\Model\StatisticsAttributionType $attribution_type attribution_type
     *
     * @return self
     */
