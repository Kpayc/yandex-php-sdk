...
/**
 * GetBusinessOrdersResponse Class Doc Comment
 *
 * @category Class
 * @description Ответ со списком заказов бизнеса.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class GetBusinessOrdersResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GetBusinessOrdersResponse';
     ...
     * Gets orders
     *
     * @return \OpenAPI\Client\Model\BusinessOrderDTO[]
     */
     ...
     * Sets orders
     *
     * @param \OpenAPI\Client\Model\BusinessOrderDTO[] $orders Список заказов в кабинете.
     *
     * @return self
     */
    public function setOrders($orders)
    {
        ...
        if ((count($orders) > 50)) {
            throw new \InvalidArgumentException('invalid value for $orders when calling GetBusinessOrdersResponse., number of items must be less than or equal to 50.');
        }
