...
/**
 * GetReturnAvailableDecisionsRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class GetReturnAvailableDecisionsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GetReturnAvailableDecisionsRequest';
    ...
    public function setCampaignId($campaign_id)
    {
        ...
        if (($campaign_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $campaign_id when calling GetReturnAvailableDecisionsRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets return_id
     *
     * @param int $return_id Идентификатор невыкупа или возврата.
     *
     * @return self
     */
    public function setReturnId($return_id)
    {
        ...
        if (($return_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $return_id when calling GetReturnAvailableDecisionsRequest., must be bigger than or equal to 1.');
        }
