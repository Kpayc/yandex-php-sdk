...
/**
 * BusinessOrderDeliveryDatesDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class BusinessOrderDeliveryDatesDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BusinessOrderDeliveryDatesDTO';
     ...
     * Sets from_date
     *
     * @param \DateTime $from_date Ближайшая дата доставки.  Формат даты: `ГГГГ-ММ-ДД`.
     *
     * @return self
     */
     ...
     * Sets to_date
     *
     * @param \DateTime|null $to_date Самая поздняя дата доставки.  Если `toDate` не указан, считается дата в параметре `fromDate`.  Формат даты: `ГГГГ-ММ-ДД`.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $real_delivery_date Дата, когда товар доставлен до пункта выдачи заказа (в случае самовывоза) или до покупателя (если заказ доставляет курьер).  Формат даты: `ГГГГ-ММ-ДД`.
     *
     * @return self
     */
