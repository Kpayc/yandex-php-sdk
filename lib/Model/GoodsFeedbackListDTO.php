 ...
 */
class GoodsFeedbackListDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GoodsFeedbackListDTO';
    ...
    protected static $openAPITypes = [
        'feedbacks' => '\OpenAPI\Client\Model\GoodsFeedbackDTO[]',
    ...
    {
        $this->setIfExists('feedbacks', $data ?? [], null);
     ...
     * Gets feedbacks
     *
     * @return \OpenAPI\Client\Model\GoodsFeedbackDTO[]
     */
    public function getFeedbacks()
    {
        return $this->container['feedbacks'];
    }

    /**
     * Sets feedbacks
     *
     * @param \OpenAPI\Client\Model\GoodsFeedbackDTO[] $feedbacks Список отзывов.
     *
     * @return self
     */
    public function setFeedbacks($feedbacks)
    {
        if (is_null($feedbacks)) {
            throw new \InvalidArgumentException('non-nullable feedbacks cannot be null');
        }
        $this->container['feedbacks'] = $feedbacks;
