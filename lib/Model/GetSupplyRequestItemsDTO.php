...
/**
 * GetSupplyRequestItemsDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class GetSupplyRequestItemsDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GetSupplyRequestItemsDTO';
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\SupplyRequestItemDTO[]
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\SupplyRequestItemDTO[] $items Список товаров.
     *
     * @return self
     */
    public function setItems($items)
    {
        ...
        if ((count($items) > 100)) {
            throw new \InvalidArgumentException('invalid value for $items when calling GetSupplyRequestItemsDTO., number of items must be less than or equal to 100.');
        }
        if ((count($items) < 0)) {
            throw new \InvalidArgumentException('invalid length for $items when calling GetSupplyRequestItemsDTO., number of items must be greater than or equal to 0.');
        }
