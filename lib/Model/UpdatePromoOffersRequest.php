...
/**
 * UpdatePromoOffersRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdatePromoOffersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UpdatePromoOffersRequest';
    ...
    protected static $openAPITypes = [
        'promo_id' => 'string',
        'offers' => '\OpenAPI\Client\Model\UpdatePromoOfferDTO[]'
    ];
     ...
     * Gets offers
     *
     * @return \OpenAPI\Client\Model\UpdatePromoOfferDTO[]
     */
     ...
     * Sets offers
     *
     * @param \OpenAPI\Client\Model\UpdatePromoOfferDTO[] $offers Товары, которые необходимо добавить в акцию или цены которых нужно изменить.
     *
     * @return self
     */
    public function setOffers($offers)
    {
        ...
        if ((count($offers) > 500)) {
            throw new \InvalidArgumentException('invalid value for $offers when calling UpdatePromoOffersRequest., number of items must be less than or equal to 500.');
        }
        if ((count($offers) < 1)) {
            throw new \InvalidArgumentException('invalid length for $offers when calling UpdatePromoOffersRequest., number of items must be greater than or equal to 1.');
        }
