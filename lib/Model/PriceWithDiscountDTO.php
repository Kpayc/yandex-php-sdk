...
/**
 * PriceWithDiscountDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class PriceWithDiscountDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PriceWithDiscountDTO';
    ...
    public function setValue($value)
    {
        ...
        if (($value <= 0)) {
            throw new \InvalidArgumentException('invalid value for $value when calling PriceWithDiscountDTO., must be bigger than 0.');
        }
    ...
    public function setDiscountBase($discount_base)
    {
        ...
        if (($discount_base <= 0)) {
            throw new \InvalidArgumentException('invalid value for $discount_base when calling PriceWithDiscountDTO., must be bigger than 0.');
        }
