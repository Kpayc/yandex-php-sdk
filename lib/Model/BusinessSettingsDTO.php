...
/**
 * BusinessSettingsDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class BusinessSettingsDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BusinessSettingsDTO';
    ...
    {
        return $this->container['only_default_price'];
    }
     ...
     * @return self
     */
    public function setOnlyDefaultPrice($only_default_price)
    {
        if (is_null($only_default_price)) {
            throw new \InvalidArgumentException('non-nullable only_default_price cannot be null');
        }
        $this->container['only_default_price'] = $only_default_price;
