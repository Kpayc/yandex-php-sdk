 ...
 */
class GetPromoOffersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'promo_id' => 'string',
        'status_type' => '\OpenAPI\Client\Model\PromoOfferParticipationStatusFilterType',
        'statuses' => '\OpenAPI\Client\Model\PromoOfferParticipationStatusMultiFilterType[]'
    ];
     ...
     * Gets status_type
     *
     * @return \OpenAPI\Client\Model\PromoOfferParticipationStatusFilterType|null
     */
     ...
     * Sets status_type
     *
     * @param \OpenAPI\Client\Model\PromoOfferParticipationStatusFilterType|null $status_type status_type
     *
     * @return self
     */
     ...
     * Gets statuses
     *
     * @return \OpenAPI\Client\Model\PromoOfferParticipationStatusMultiFilterType[]|null
     */
     ...
     * Sets statuses
     *
     * @param \OpenAPI\Client\Model\PromoOfferParticipationStatusMultiFilterType[]|null $statuses Фильтр для товаров, которые могут участвовать в акции. Можно задать несколько значений.
     *
     * @return self
     */
