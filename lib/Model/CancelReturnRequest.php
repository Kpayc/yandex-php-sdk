...
/**
 * CancelReturnRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CancelReturnRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CancelReturnRequest';
     ...
     * Sets return_id
     *
     * @param int $return_id Идентификатор возврата.
     *
     * @return self
     */
