...
/**
 * GenerateBannersStatisticsRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class GenerateBannersStatisticsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GenerateBannersStatisticsRequest';
    ...
    public function setBusinessId($business_id)
    {
        ...
        if (($business_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $business_id when calling GenerateBannersStatisticsRequest., must be bigger than or equal to 1.');
        }
