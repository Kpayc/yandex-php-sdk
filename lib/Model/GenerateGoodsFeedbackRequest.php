...
/**
 * GenerateGoodsFeedbackRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class GenerateGoodsFeedbackRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GenerateGoodsFeedbackRequest';
    ...
    public function setBusinessId($business_id)
    {
        ...
        if (($business_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $business_id when calling GenerateGoodsFeedbackRequest., must be bigger than or equal to 1.');
        }
