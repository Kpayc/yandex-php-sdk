...
/**
 * GetPromoConstraintsDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class GetPromoConstraintsDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GetPromoConstraintsDTO';
     ...
     * Sets warehouse_ids
     *
     * @param int[]|null $warehouse_ids Идентификаторы складов, для которых действует акция. Товары, которые лежат на других складах, не будут продаваться по акции.  Параметр возвращается, только если в условиях акции есть ограничение по складу.
     *
     * @return self
     */
    public function setWarehouseIds($warehouse_ids)
    {
        ...
        if (!is_null($warehouse_ids) && (count($warehouse_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_ids when calling GetPromoConstraintsDTO., number of items must be greater than or equal to 1.');
        }
