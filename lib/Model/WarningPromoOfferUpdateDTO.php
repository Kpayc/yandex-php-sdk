...
/**
 * WarningPromoOfferUpdateDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class WarningPromoOfferUpdateDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'WarningPromoOfferUpdateDTO';
    ...
    protected static $openAPITypes = [
        'offer_id' => 'string',
        'warnings' => '\OpenAPI\Client\Model\PromoOfferUpdateWarningDTO[]'
    ];
    ...
    public function setOfferId($offer_id)
    {
        ...
        if ((mb_strlen($offer_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $offer_id when calling WarningPromoOfferUpdateDTO., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($offer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $offer_id when calling WarningPromoOfferUpdateDTO., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^(?=.*\\S.*)[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/", ObjectSerializer::toString($offer_id)))) {
            throw new \InvalidArgumentException("invalid value for \$offer_id when calling WarningPromoOfferUpdateDTO., must conform to the pattern /^(?=.*\\S.*)[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/.");
        }
     ...
     * Gets warnings
     *
     * @return \OpenAPI\Client\Model\PromoOfferUpdateWarningDTO[]
     */
     ...
     * Sets warnings
     *
     * @param \OpenAPI\Client\Model\PromoOfferUpdateWarningDTO[] $warnings Предупреждения, которые появились при добавлении товара в акцию или изменении его цен.
     *
     * @return self
     */
