...
/**
 * ClosureDocumentsMonthOfYearDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class ClosureDocumentsMonthOfYearDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ClosureDocumentsMonthOfYearDTO';
    ...
    public function setMonth($month)
    {
        ...
        if (($month > 12)) {
            throw new \InvalidArgumentException('invalid value for $month when calling ClosureDocumentsMonthOfYearDTO., must be smaller than or equal to 12.');
        }
        if (($month < 1)) {
            throw new \InvalidArgumentException('invalid value for $month when calling ClosureDocumentsMonthOfYearDTO., must be bigger than or equal to 1.');
        }
