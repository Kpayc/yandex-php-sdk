...
/**
 * GenerateJewelryFiscalReportRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class GenerateJewelryFiscalReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GenerateJewelryFiscalReportRequest';
    ...
    public function setCampaignId($campaign_id)
    {
        ...
        if (($campaign_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $campaign_id when calling GenerateJewelryFiscalReportRequest., must be bigger than or equal to 1.');
        }
