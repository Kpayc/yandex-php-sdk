...
/**
 * GetOperationsRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class GetOperationsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GetOperationsRequest';
    ...
    protected static $openAPITypes = [
        'operation_type' => '\OpenAPI\Client\Model\OperationType',
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['operation_ids']) > 100)) {
            $invalidProperties[] = "invalid value for 'operation_ids', number of items must be less than or equal to 100.";
        }
     ...
     * Gets operation_type
     *
     * @return \OpenAPI\Client\Model\OperationType
     */
     ...
     * Sets operation_type
     *
     * @param \OpenAPI\Client\Model\OperationType $operation_type operation_type
     *
     * @return self
     */
     ...
     * Sets operation_ids
     *
     * @param string[] $operation_ids Список идентификаторов операций.
     *
     * @return self
     */
    public function setOperationIds($operation_ids)
    {
        ...
        if ((count($operation_ids) > 100)) {
            throw new \InvalidArgumentException('invalid value for $operation_ids when calling GetOperationsRequest., number of items must be less than or equal to 100.');
        }
        if ((count($operation_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $operation_ids when calling GetOperationsRequest., number of items must be greater than or equal to 1.');
        }
