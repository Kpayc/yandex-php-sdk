...
/**
 * GenerateKeyIndicatorsRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class GenerateKeyIndicatorsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GenerateKeyIndicatorsRequest';
    ...
    public function setBusinessId($business_id)
    {
        ...
        if (($business_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $business_id when calling GenerateKeyIndicatorsRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setCampaignId($campaign_id)
    {
        ...
        if (($campaign_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $campaign_id when calling GenerateKeyIndicatorsRequest., must be bigger than or equal to 1.');
        }
