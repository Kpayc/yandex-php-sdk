...
class ProvideOrderDigitalCodesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\OrderDigitalItemDTO[] $items Список проданных товаров.  Для товара с одинаковым `id` передавайте один элемент и массив `codes` по количеству ключей.
     *
     * @return self
     */
