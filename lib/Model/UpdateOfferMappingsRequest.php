...
class UpdateOfferMappingsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets offer_mappings
     *
     * @param \OpenAPI\Client\Model\UpdateOfferMappingDTO[] $offer_mappings Список товаров, которые нужно добавить или обновить.  {% note warning \"Скоро мы уменьшим максимальное количество товаров в запросе\" %}  Уже сейчас не передавайте больше 100.  {% endnote %}   
     *
     * @return self
     */
