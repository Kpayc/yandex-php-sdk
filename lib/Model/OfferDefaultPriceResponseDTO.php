...
/**
 * OfferDefaultPriceResponseDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class OfferDefaultPriceResponseDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'OfferDefaultPriceResponseDTO';
    ...
    protected static $openAPITypes = [
        'offer_id' => 'string',
        'price' => '\OpenAPI\Client\Model\OfferDefaultPriceDTO'
    ];
    ...
    public function setOfferId($offer_id)
    {
        ...
        if ((mb_strlen($offer_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $offer_id when calling OfferDefaultPriceResponseDTO., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($offer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $offer_id when calling OfferDefaultPriceResponseDTO., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^(?=.*\\S.*)[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/", ObjectSerializer::toString($offer_id)))) {
            throw new \InvalidArgumentException("invalid value for \$offer_id when calling OfferDefaultPriceResponseDTO., must conform to the pattern /^(?=.*\\S.*)[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/.");
        }
     ...
     * Gets price
     *
     * @return \OpenAPI\Client\Model\OfferDefaultPriceDTO|null
     */
     ...
     * Sets price
     *
     * @param \OpenAPI\Client\Model\OfferDefaultPriceDTO|null $price price
     *
     * @return self
     */
