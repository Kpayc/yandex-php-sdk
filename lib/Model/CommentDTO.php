...
class CommentDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['answer_id'] < 1)) {
            $invalidProperties[] = "invalid value for 'answer_id', must be bigger than or equal to 1.";
        }
     ...
     * Sets id
     *
     * @param int $id Идентификатор комментария к ответу.
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling CommentDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setText($text)
    {
        ...
        if ((mb_strlen($text) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $text when calling CommentDTO., must be smaller than or equal to 5000.');
        }
        if ((mb_strlen($text) < 1)) {
            throw new \InvalidArgumentException('invalid length for $text when calling CommentDTO., must be bigger than or equal to 1.');
        }
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\QuestionsTextContentModerationStatusType $status status
     *
     * @return self
     */
     ...
     * Sets answer_id
     *
     * @param int $answer_id Идентификатор ответа на вопрос.
     *
     * @return self
     */
    public function setAnswerId($answer_id)
    {
        ...
        if (($answer_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $answer_id when calling CommentDTO., must be bigger than or equal to 1.');
        }
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at Дата создания комментария.
     *
     * @return self
     */
     ...
     * Sets votes
     *
     * @param \OpenAPI\Client\Model\VotesDTO|null $votes votes
     *
     * @return self
     */
