...
/**
 * CampaignQualityRatingDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class CampaignQualityRatingDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CampaignQualityRatingDTO';
    ...
    protected static $openAPITypes = [
        'campaign_id' => 'int',
        'ratings' => '\OpenAPI\Client\Model\QualityRatingDTO[]'
    ];
    ...
    public function setCampaignId($campaign_id)
    {
        ...
        if (($campaign_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $campaign_id when calling CampaignQualityRatingDTO., must be bigger than or equal to 1.');
        }
     ...
     * Gets ratings
     *
     * @return \OpenAPI\Client\Model\QualityRatingDTO[]
     */
     ...
     * Sets ratings
     *
     * @param \OpenAPI\Client\Model\QualityRatingDTO[] $ratings Список значений индекса качества.
     *
     * @return self
     */
