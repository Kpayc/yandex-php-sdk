...
class GenerateBoostConsolidatedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GenerateBoostConsolidatedRequest';
    ...
    public function setBusinessId($business_id)
    {
        ...
        if (($business_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $business_id when calling GenerateBoostConsolidatedRequest., must be bigger than or equal to 1.');
        }
