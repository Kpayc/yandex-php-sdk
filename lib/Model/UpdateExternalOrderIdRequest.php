...
/**
 * UpdateExternalOrderIdRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateExternalOrderIdRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UpdateExternalOrderIdRequest';
     ...
     *
     * @param string $external_order_id Внешний идентификатор заказа.
     *
     * @return self
     */
    public function setExternalOrderId($external_order_id)
    {
        ...
        if ((mb_strlen($external_order_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $external_order_id when calling UpdateExternalOrderIdRequest., must be bigger than or equal to 1.');
        }
