 ...
 */
class GenerateUnitedReturnsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'return_status_types' => '\OpenAPI\Client\Model\ReturnShipmentStatusType[]'
    ];
     ...
     *
     * @param \OpenAPI\Client\Model\ReturnShipmentStatusType[]|null $return_status_types Статусы передачи возвратов, которые нужны в отчете.  Если их не указать, вернется информация по всем возвратам.
     *
     * @return self
     */
