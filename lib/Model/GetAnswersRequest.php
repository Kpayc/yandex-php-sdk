...
/**
 * GetAnswersRequest Class Doc Comment
 *
 * @category Class
 * @description Фильтр запроса ответов на вопрос.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class GetAnswersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GetAnswersRequest';
     ...
     * Sets question_id
     *
     * @param int|null $question_id Идентификатор вопроса.
     *
     * @return self
     */
    public function setQuestionId($question_id)
    {
        ...
        if (($question_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $question_id when calling GetAnswersRequest., must be bigger than or equal to 1.');
        }
