...
class BidRecommendationItemDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'bid' => 'int',
        'show_percent' => 'int',
        'benefits' => '\OpenAPI\Client\Model\BenefitType[]'
    ];
     ...
     * Gets benefits
     *
     * @return \OpenAPI\Client\Model\BenefitType[]|null
     */
     ...
     * Sets benefits
     *
     * @param \OpenAPI\Client\Model\BenefitType[]|null $benefits Список доступных субсидий.  Чтобы получить необходимый инструмент продвижения, установите ставку, которая будет рекомендована для этого инструмента или выше.
     *
     * @return self
     */
