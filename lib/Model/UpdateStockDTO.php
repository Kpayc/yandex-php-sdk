...
class UpdateStockDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'sku' => 'string',
        'items' => '\OpenAPI\Client\Model\UpdateStockItemDTO[]'
    ];
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\UpdateStockItemDTO[]
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\UpdateStockItemDTO[] $items Информация об остатках товара.
     *
     * @return self
     */
