...
/**
 * UpdateOfferMappingResultDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateOfferMappingResultDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UpdateOfferMappingResultDTO';
    ...
    protected static $openAPITypes = [
        'offer_id' => 'string',
        'errors' => '\OpenAPI\Client\Model\OfferMappingErrorDTO[]',
        'warnings' => '\OpenAPI\Client\Model\OfferMappingErrorDTO[]'
    ];
    ...
    public function setOfferId($offer_id)
    {
        ...
        if ((mb_strlen($offer_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $offer_id when calling UpdateOfferMappingResultDTO., must be smaller than or equal to 255.');
        }
     ...
     * Gets errors
     *
     * @return \OpenAPI\Client\Model\OfferMappingErrorDTO[]|null
     */
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\Model\OfferMappingErrorDTO[]|null $errors Ошибки.  Если хотя бы по одному товару есть ошибка, информация в каталоге не обновится по всем переданным товарам.
     *
     * @return self
     */
    public function setErrors($errors)
    {
        ...
        if (!is_null($errors) && (count($errors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $errors when calling UpdateOfferMappingResultDTO., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets warnings
     *
     * @param \OpenAPI\Client\Model\OfferMappingErrorDTO[]|null $warnings Предупреждения.  Информация в каталоге обновится.
     *
     * @return self
     */
    public function setWarnings($warnings)
    {
        ...
        if (!is_null($warnings) && (count($warnings) < 1)) {
            throw new \InvalidArgumentException('invalid length for $warnings when calling UpdateOfferMappingResultDTO., number of items must be greater than or equal to 1.');
        }
