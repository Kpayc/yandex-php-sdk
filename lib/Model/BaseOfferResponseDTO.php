...
/**
 * BaseOfferResponseDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class BaseOfferResponseDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BaseOfferResponseDTO';
    ...
    public function setOfferId($offer_id)
    {
        ...
        if ((mb_strlen($offer_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $offer_id when calling BaseOfferResponseDTO., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($offer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $offer_id when calling BaseOfferResponseDTO., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^(?=.*\\S.*)[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/", ObjectSerializer::toString($offer_id)))) {
            throw new \InvalidArgumentException("invalid value for \$offer_id when calling BaseOfferResponseDTO., must conform to the pattern /^(?=.*\\S.*)[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/.");
        }
    ...
    public function setMarketCategoryId($market_category_id)
    {
        ...
        if (($market_category_id <= 0)) {
            throw new \InvalidArgumentException('invalid value for $market_category_id when calling BaseOfferResponseDTO., must be bigger than 0.');
        }
    ...
    public function setPictures($pictures)
    {
        ...
        if (!is_null($pictures) && (count($pictures) < 1)) {
            throw new \InvalidArgumentException('invalid length for $pictures when calling BaseOfferResponseDTO., number of items must be greater than or equal to 1.');
        }
    ...
    public function setVideos($videos)
    {
        ...
        if (!is_null($videos) && (count($videos) < 1)) {
            throw new \InvalidArgumentException('invalid length for $videos when calling BaseOfferResponseDTO., number of items must be greater than or equal to 1.');
        }
    ...
    public function setManuals($manuals)
    {
        ...
        if (!is_null($manuals) && (count($manuals) < 1)) {
            throw new \InvalidArgumentException('invalid length for $manuals when calling BaseOfferResponseDTO., number of items must be greater than or equal to 1.');
        }
    ...
    public function setBarcodes($barcodes)
    {
        ...
        if (!is_null($barcodes) && (count($barcodes) < 1)) {
            throw new \InvalidArgumentException('invalid length for $barcodes when calling BaseOfferResponseDTO., number of items must be greater than or equal to 1.');
        }
    ...
    public function setManufacturerCountries($manufacturer_countries)
    {
        ...
        if (!is_null($manufacturer_countries) && (count($manufacturer_countries) < 1)) {
            throw new \InvalidArgumentException('invalid length for $manufacturer_countries when calling BaseOfferResponseDTO., number of items must be greater than or equal to 1.');
        }
    ...
    public function setTags($tags)
    {
        ...
        if (!is_null($tags) && (count($tags) > 50)) {
            throw new \InvalidArgumentException('invalid value for $tags when calling BaseOfferResponseDTO., number of items must be less than or equal to 50.');
        }
        if (!is_null($tags) && (count($tags) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tags when calling BaseOfferResponseDTO., number of items must be greater than or equal to 1.');
        }
    ...
    public function setCommodityCodes($commodity_codes)
    {
        ...
        if (!is_null($commodity_codes) && (count($commodity_codes) < 1)) {
            throw new \InvalidArgumentException('invalid length for $commodity_codes when calling BaseOfferResponseDTO., number of items must be greater than or equal to 1.');
        }
    ...
    public function setCertificates($certificates)
    {
        ...
        if (!is_null($certificates) && (count($certificates) < 1)) {
            throw new \InvalidArgumentException('invalid length for $certificates when calling BaseOfferResponseDTO., number of items must be greater than or equal to 1.');
        }
    ...
    public function setBoxCount($box_count)
    {
        ...
        if (($box_count < 1)) {
            throw new \InvalidArgumentException('invalid value for $box_count when calling BaseOfferResponseDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setParams($params)
    {
        ...
        if (!is_null($params) && (count($params) < 1)) {
            throw new \InvalidArgumentException('invalid length for $params when calling BaseOfferResponseDTO., number of items must be greater than or equal to 1.');
        }
