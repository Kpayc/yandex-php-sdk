...
/**
 * GenerateSalesGeographyRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class GenerateSalesGeographyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GenerateSalesGeographyRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['category_ids']) && (count($this->container['category_ids']) > 1000)) {
            $invalidProperties[] = "invalid value for 'category_ids', number of items must be less than or equal to 1000.";
        }
        ...
        if (!is_null($this->container['offer_ids']) && (count($this->container['offer_ids']) > 1000)) {
            $invalidProperties[] = "invalid value for 'offer_ids', number of items must be less than or equal to 1000.";
        }
    ...
    public function setBusinessId($business_id)
    {
        ...
        if (($business_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $business_id when calling GenerateSalesGeographyRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets category_ids
     *
     * @param int[]|null $category_ids Идентификаторы категорий.
     *
     * @return self
     */
    public function setCategoryIds($category_ids)
    {
        ...
        if (!is_null($category_ids) && (count($category_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $category_ids when calling GenerateSalesGeographyRequest., number of items must be less than or equal to 1000.');
        }
        if (!is_null($category_ids) && (count($category_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $category_ids when calling GenerateSalesGeographyRequest., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets offer_ids
     *
     * @param string[]|null $offer_ids Идентификаторы товаров.
     *
     * @return self
     */
    public function setOfferIds($offer_ids)
    {
        ...
        if (!is_null($offer_ids) && (count($offer_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $offer_ids when calling GenerateSalesGeographyRequest., number of items must be less than or equal to 1000.');
        }
        if (!is_null($offer_ids) && (count($offer_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $offer_ids when calling GenerateSalesGeographyRequest., number of items must be greater than or equal to 1.');
        }
