...
/**
 * DeliveryDateIntervalDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class DeliveryDateIntervalDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DeliveryDateIntervalDTO';
     ...
     * Sets from_date
     *
     * @param \DateTime $from_date Начало интервала.  Формат даты: `ГГГГ-ММ-ДД`.
     *
     * @return self
     */
     ...
     * Sets to_date
     *
     * @param \DateTime $to_date Конец интервала.  Формат даты: `ГГГГ-ММ-ДД`.
     *
     * @return self
     */
